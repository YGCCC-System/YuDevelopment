...
import { serviceOfferingsDirect, whyUsDirect, processStepsDirect, developersFAQ } from '@/lib/servicesContent';

export const metadata: Metadata = {
  title: 'Design, Engineering & Permitting for Multifamily and Commercial Developers',
  description:
    'A Southeast multifamily developer with an in-house team of draftsmen, architects, civil, structural, and MEP engineers, ready to take your development from land to a permit-ready set.',
};
...
export default function DevelopersServicesPage() {
  return (
    <>
      ...
      <HeroVideo
        ...
        headline="Your development, permit-ready, without building an in-house design team."
        subhead="We are an Atlanta based multifamily developer with our own licensed team of draftsmen, architects, civil, structural, and MEP engineers, so your plans move in-house instead of through five different vendors."
      />
      <TownsMarquee />
      <RecentWork
        audience="developers"
        lede="A sample of plan sets we’ve produced for developers like you, plus concept sets you can browse before you send us a project."
      />
      <ServiceOfferings
        offerings={serviceOfferingsDirect}
        heading="One team, every discipline your development needs"
        lede="From drafting through sign, stamp & seal, everything is coordinated in-house and delivered as one submittal-ready set, not five separate vendor hand-offs."
      />
      <Testimonials heading="What our clients say" />
      <WhyUs items={whyUsDirect} heading="Why developers work with us" />
      <ProcessSteps steps={processStepsDirect} />
      <ServicesFAQ faq={developersFAQ} />
      <CalendlyEmbed
        ctaHeadline="Tell us about your project"
        questions={['What’s the project?', 'Where’s the land located?', 'What’s your timeline?']}
      />
